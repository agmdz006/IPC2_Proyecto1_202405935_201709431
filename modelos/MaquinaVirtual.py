...
class MaquinaVirtual:
    ...
    #================== función para eliminar un contenedor de la vm ======================================
    def eliminar_contenedor(self, id_contenedor):
        ...
        while nodo_contenedor_actual is not None:
            if nodo_contenedor_actual.dato.identificador_servicio.strip() == id_contenedor.strip(): #limpiamos tanto la entrada como la variable a comparar
                contenedor_a_eliminar = nodo_contenedor_actual.dato
                
                # Liberamos los recursos que estaba consumiendo el contenedor decrementando la cantidad
    ...
    #=================================== función str para retornar datos =========================================================
    def __str__(self):
        ram_total_mb = self.recursos.memoria_maxima * 1024
